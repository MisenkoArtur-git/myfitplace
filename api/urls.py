...
urlpatterns = [
    ...
    path('communication-find-api/', views.communication_find_api, name='communication_find_api'),
    path('communication-add-api/', views.communication_add_api, name='communication_add_api'),
    path('communication-delete-api/', views.communication_delete_api, name='communication_delete_api'),
